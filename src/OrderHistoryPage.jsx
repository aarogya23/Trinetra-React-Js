  ...
  useEffect(() => {
    const fetchOrderHistory = () => {
      ...
      try {
        ...
        // Format payment data for pie chart, filtering out empty values
        const formattedPayment = Object.entries(paymentMap)
        ...
        // Format monthly data for bar chart, ensuring chronological order
        ...
        console.log('Payment data:', formattedPayment);
        console.log('Monthly data:', formattedMonthly);
  ...
  return (
    <div className="order-history-container">
      ...
      <div className="order-history-content">
        ...
        {/* Charts Section */}
        {!isLoading && orders.length > 0 && paymentData.length > 0 && monthlySalesData.length > 0 && (
          <div className="charts-section">
            <div className="chart-card">
              <h2 className='payment-h2'>Payment Method Distribution</h2>
            ...
            <div className="chart-card">
              ...
              <ResponsiveContainer width="100%" height={300} minWidth={250}>
                ...
                >
                  ...
                  <XAxis dataKey="month" />
                  <YAxis />
                  <Tooltip formatter={(value) => [`Rs. ${value.toFixed(2)}`, 'Sales']} />
                  <Legend />
